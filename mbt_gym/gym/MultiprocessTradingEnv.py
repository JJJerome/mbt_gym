...
class MultiprocessTradingEnv(VecEnv):
    """
    ...
    This .... [creates a multiprocess vectorized wrapper for multiple environments, distributing each environment to its
    ...
    def __init__(self, env_fns: List[Callable[[], gym.Env]], start_method: Optional[str] = None):
        ...
        print(f"Start method is {start_method}")
